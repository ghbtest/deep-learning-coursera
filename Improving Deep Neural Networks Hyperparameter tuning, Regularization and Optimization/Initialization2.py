...
xscales=[1.5, 5, 10, 100]
paramscales=[1, 1.5, 3, 10, 20]
for i in range(len(xszs)):
    xscale=xszs[i]
    for j in range(len(paramscales)):
        pscale=paramscales[j]
        Experiment myexp=new Experiment(xscale, pscale)
        myexp.getResults()
